...
export const VITAMIN_C_FACEWASH_IMAGE = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(`
...
export const OLIVE_SOUFFLE_CREAM_IMAGE = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" width="100%" height="100%">
  <defs>
...
import comboDuoImg from '../assets/images/regenerated_image_1786447986783.jpg';
import product2Img from '../assets/images/regenerated_image_1786448396131.jpg';

export const COMBO_DUO_IMAGE = comboDuoImg;
export const PRODUCT_2_IMAGE = product2Img;
